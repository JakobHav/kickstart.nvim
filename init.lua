...
vim.keymap.set('n', '<leader>tb', toggle_bool.tb, { desc = 'Toggle true/false (ignore case)' })
...
-- Window Nav
vim.keymap.set({ 'n', 'i', 'v' }, '<C-b>', ':Neotree toggle<CR>', { noremap = true, silent = true })
...
vim.keymap.set({ 'n', 'i', 'v' }, '<leader>sv', '<cmd>find ~/.config/nvim/init.lua<CR>', { desc = 'Opens NVIM config' })
...
require('lazy').setup {
  ...
  },
  {
    ...
    dependencies = {
      ...
      'lewis6991/gitsigns.nvim', -- optional but enhances UI
    },
    lazy = false,
    init = function()
      -- Keymaps to make barbar behave more like tab switching
  ...
  -- lualine
  {
    ...
    config = function()
      require('lualine').setup {
        options = {
          theme = 'gruvbox', -- pick your favorite colorscheme or 'auto'
          section_separators = { '', '' },
